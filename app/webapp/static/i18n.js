...
const I18N = {
  ...
  service_request_error: { ru: "Не получилось отправить — проверь заполненные поля", hy: "Չհաջողվեց ուղարկել", en: "Couldn't submit — check the filled fields" },
  ...
  service_insufficient_balance: { ru: "Недостаточно средств на балансе", hy: "Հաշվեկշռում բավարար միջոցներ չկան", en: "Insufficient balance" },
