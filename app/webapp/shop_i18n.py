...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "order_summary_title": {"ru": "Сводка заказа", "hy": "Պատվերի ամփոփում", "en": "Order summary"},
    "order_plan_label": {"ru": "Тариф", "hy": "Փաթեթ", "en": "Plan"},
    "order_validity_label": {"ru": "Срок действия", "hy": "Վավերականություն", "en": "Validity"},
    "order_coverage_label": {"ru": "Покрытие", "hy": "Ծածկույթ", "en": "Coverage"},
    "order_total_label": {"ru": "Оплачено", "hy": "Վճարված է", "en": "Charged"},
    "order_data_label": {"ru": "Объём данных", "hy": "Ինտերնետի ծավալ", "en": "Data included"},
    "link_copied": {"ru": "Ссылка скопирована", "hy": "Հղումը պատճենվեց", "en": "Link copied"},

    "order_ready_title": {"ru": "Ваш eSIM готов к установке", "hy": "Ձեր eSIM-ը պատրաստ է տեղադրման", "en": "Your eSIM is ready to install"},
    "order_ready_subtitle": {
        "ru": "Отсканируйте QR-код камерой телефона или в настройках сети, либо введите код активации вручную.",
        "hy": "Սկանավորեք QR-կոդը հեռախոսի տեսախցիկով կամ ցանցի կարգավորումներում, կամ մուտքագրեք ակտիվացման կոդը ձեռքով։",
        "en": "Scan the QR code with your phone camera or in network settings, or enter the activation code manually.",
    },
    "order_scan_hint": {
        "ru": "Наведите камеру телефона прямо на этот QR-код или перейдите в настройки сети вручную.",
        "hy": "Ուղղեք հեռախոսի տեսախցիկը այս QR-կոդին կամ անցեք ցանցի կարգավորումներ ձեռքով։",
        "en": "Point your phone camera directly at this QR code, or open it via network settings manually.",
    },
    "order_save_image": {"ru": "Сохранить", "hy": "Պահպանել", "en": "Save Image"},
    "order_share": {"ru": "Поделиться", "hy": "Կիսվել", "en": "Share eSIM"},
    "order_print": {"ru": "Печать", "hy": "Տպել", "en": "Print Ticket"},
    "order_manual_details": {"ru": "Данные для ручной активации", "hy": "Ձեռքով ակտիվացման տվյալներ", "en": "Manual Activation Details"},

    "order_dual_sim_title": {"ru": "Работает вместе с вашей обычной SIM", "hy": "Աշխատում է ձեր սովորական SIM-ի հետ", "en": "Dual-SIM peace of mind"},
    "order_dual_sim_1_title": {"ru": "Основной номер остаётся активен: ", "hy": "Հիմնական համարը մնում է ակտիվ․ ", "en": "Keep your primary number on: "},
    "order_dual_sim_1_text": {
        "ru": "SMS, коды подтверждения и звонки продолжат приходить на неё без изменений.",
        "hy": "SMS-ները, հաստատման կոդերը և զանգերը կշարունակեն գալ առանց փոփոխության։",
        "en": "You'll keep receiving SMS, verification codes and calls on it as usual.",
    },
    "order_dual_sim_2_title": {"ru": "Мобильный интернет: ", "hy": "Բջջային ինտերնետ․ ", "en": "Cellular data: "},
    "order_dual_sim_2_text": {
        "ru": "переключите на KaLine eSIM и включите роуминг данных, чтобы не платить домашнему оператору.",
        "hy": "անցեք KaLine eSIM-ին և միացրեք ինտերնետային ռոումինգը՝ տնային օպերատորին չվճարելու համար։",
        "en": "switch it to KaLine eSIM and turn on data roaming so charges don't spill onto your home carrier.",
    },
    "order_help_title": {"ru": "Нужна помощь с установкой?", "hy": "Օգնություն է պետք տեղադրման հետ?", "en": "Need help installing?"},
    "order_help_cta": {"ru": "Открыть чат", "hy": "Բացել չաթը", "en": "Open Chat"},

    "order_install_title": {"ru": "Как установить на устройство", "hy": "Ինչպես տեղադրել սարքում", "en": "How to install on your device"},
    "order_install_subtitle": {
        "ru": "Займёт меньше минуты. Можно установить заранее, до вылета.",
        "hy": "Կպահանջվի րոպեից քիչ ժամանակ։ Կարող եք տեղադրել նախապես՝ մինչև թռիչքը։",
        "en": "Takes less than a minute. You can install it now, before departure.",
    },
    "order_tab_iphone": {"ru": "iPhone / iPad", "hy": "iPhone / iPad", "en": "iPhone / iPad"},
    "order_tab_android": {"ru": "Samsung / Android", "hy": "Samsung / Android", "en": "Samsung / Android"},
    "order_step1_title": {"ru": "Открыть настройки сети", "hy": "Բացեք ցանցի կարգավորումները", "en": "Open Cellular Settings"},
    "order_step1_ios": {
        "ru": "Настройки → Сотовая связь → Добавить eSIM (или «Настроить сотовую связь»).",
        "hy": "Կարգավորումներ → Բջջային կապ → Ավելացնել eSIM։",
        "en": "Settings → Cellular → Add eSIM (or \"Set Up Cellular Service\").",
    },
    "order_step1_android": {
        "ru": "Настройки → Сеть и интернет → SIM-карты → Добавить eSIM.",
        "hy": "Կարգավորումներ → Ցանց → SIM քարտեր → Ավելացնել eSIM։",
        "en": "Settings → Network & Internet → SIM cards → Add eSIM.",
    },
    "order_step1_hint": {"ru": "Нужен Wi-Fi", "hy": "Անհրաժեշտ է Wi-Fi", "en": "Requires Wi-Fi connection"},
    "order_step2_title": {"ru": "Отсканировать или ввести код", "hy": "Սկանավորեք կամ մուտքագրեք կոդը", "en": "Scan or Enter Code"},
    "order_step2_text": {
        "ru": "Отсканируйте QR-код выше камерой или выберите «Ввести данные вручную» и вставьте код активации.",
        "hy": "Սկանավորեք վերևի QR-կոդը կամ ընտրեք «Մուտքագրել ձեռքով» և տեղադրեք ակտիվացման կոդը։",
        "en": "Scan the QR code above with your camera, or choose \"Enter Details Manually\" and paste the activation code.",
    },
    "order_step2_hint": {"ru": "Мгновенная активация", "hy": "Ակնթարթային ակտիվացում", "en": "Instant profile download"},
    "order_step3_title": {"ru": "Включить по прибытии", "hy": "Միացրեք ժամանելուն պես", "en": "Turn On Upon Arrival"},
    "order_step3_text": {
        "ru": "Назовите линию «KaLine Roaming». По прибытии включите для неё роуминг данных.",
        "hy": "Անվանեք գիծը «KaLine Roaming»։ Ժամանելուն պես միացրեք դրա համար ինտերնետային ռոումինգը։",
        "en": "Label this line \"KaLine Roaming\". When you land, turn on data roaming for it.",
    },
    "order_step3_hint": {"ru": "Автоматическое подключение", "hy": "Ավտոմատ միացում", "en": "Automatic carrier handshake"},
